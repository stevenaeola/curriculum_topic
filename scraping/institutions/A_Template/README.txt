...

{
    ...
    "module": {
        "moduleContainers": {"XPath": "XPATH TO THE MODULE LINKS ON THE MODULE OVERVIEW PAGE. THIS PAGE SHOULD CONSIST OF MULTIPLE LINKS AND MAYBE MULTIPLE TABLES OF LINKS, SO THE XPATH MAY BE NON-TRIVIAL.
